...
phi10 = 280 * bK * (5 * (lambda1 * lambda2 + lambda2 * lambda3 + lambda3 * lambda1) - 1);
phi7 = 6 * bK * (2 * lambda1 - 1) + phi10 / 60;
phi8 = 6 * bK * (2 * lambda2 - 1) + phi10 / 60;
phi9 = 6 * bK * (2 * lambda3 - 1) + phi10 / 60;
phi = [
    ...
    4 * lambda2 * lambda3 + 12 * bK * (1 - 4 * lambda1) - 2 / 15 * phi10;
    4 * lambda3 * lambda1 + 12 * bK * (1 - 4 * lambda2) - 2 / 15 * phi10;
    4 * lambda1 * lambda2 + 12 * bK * (1 - 4 * lambda3) - 2 / 15 * phi10;
